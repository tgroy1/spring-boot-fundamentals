package com.tgroy.trackzilla.mutator;
...
import com.tgroy.trackzilla.exception.ApplicationNotFoundGraphQLException;
...
public class Mutation implements GraphQLMutationResolver {
    ...
    public Application updateApplicationOwner(String newOwner, Long id) {
        ...
        if(optionalApplication.isPresent()) {
            ...
            throw new ApplicationNotFoundGraphQLException("Application Not Found", id);
        }
    }
}
